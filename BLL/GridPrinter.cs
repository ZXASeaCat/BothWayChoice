...
namespace BLL
{
    ...
    public class GridPrinter
    {
        ...
        //初始化GridPrinter
        public static GridPrinter InitializePrinting(DataGridView dataGridView, PrintDocument printDocument)
        {
            ...
            return new GridPrinter(dataGridView, printDocument, true, true, "", new Font("黑体", 18, FontStyle.Bold, GraphicsUnit.Point), Color.Blue, true);
